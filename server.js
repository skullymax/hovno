...
bot.OWNERID = '336612686185889792';
bot.PREFIX = '/';
bot.TOKEN = 'NDM0ODE0MTUzMTA3MTc3NDg0.Dbj9Sg.Md1TXcCA5phSUb5rGbNNE573vSo';
...
bot.on("ready", () => {
    ...
    bot.user.setActivity("/help  |  " + bot.guilds.array().length + " servers");
    loadCommands();
});
